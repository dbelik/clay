<template>
  ...
  <section>
    <content-container class="my-16px bg-white h-64 rounded-lg">
      <!--<carousel :items-to-show="1.5" class="h-full">
        <slide v-for="slide in 10" :key="slide" class="h-58">
          <div class="h-full">123123</div>
        </slide>
        <template #addons>
          <navigation />
          <pagination />
